...
internal class AutoRemoveMessageService : IAutoRemoveMessageService
{
    ...
    public Task RegisterRemovableMessageAsync(IUser user, EmbedBuilder embed, Func<EmbedBuilder, Task<IUserMessage>> callback)
        => RegisterRemovableMessageAsync([user], embed, callback);

    /// <inheritdoc />
    public async Task RegisterRemovableMessageAsync(IUser[] users, EmbedBuilder embed, Func<EmbedBuilder, Task<IUserMessage>> callback)
    {
