...
public static class DesignatedRoleMappings
{
    ...
    public static IEnumerable<(string name, DesignatedRoleMappingSearchCriteria? criteria, long[] resultIds)> Searches
        = new[]
        {
            ...
            (
                "RoleIds Valid(1)",
                new DesignatedRoleMappingSearchCriteria() { RoleIds = [1UL] },
                new long[] { 1 }
            ),
            (
                "RoleIds Valid(2)",
                new DesignatedRoleMappingSearchCriteria() { RoleIds = [3UL] },
                new long[] { 2, 4 }
            ),
            (
                "RoleIds Valid(3)",
                new DesignatedRoleMappingSearchCriteria() { RoleIds = [1UL, 3UL] },
                new long[] { 1, 2, 4 }
            ),
            (
                "RoleIds Invalid(1)",
