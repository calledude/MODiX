...
public static class ClaimMappings
{
    ...
    public static IEnumerable<(string name, ClaimMappingSearchCriteria? criteria, long[] resultIds)> Searches
        = new[]
        {
            ...
            (
                "Empty Types",
                new ClaimMappingSearchCriteria() { Types = [] },
                new long [] { 1, 2, 3, 4 }
            ),
            (
                "Types Valid (1)",
                new ClaimMappingSearchCriteria() { Types = [ClaimMappingType.Granted] },
                new long [] { 1, 4 }
            ),
            (
                "Types Valid (2)",
                new ClaimMappingSearchCriteria() { Types = [ClaimMappingType.Denied] },
                new long [] { 2, 3 }
            ),
            (
                "Types Valid(multiple)",
                new ClaimMappingSearchCriteria() { Types = [ClaimMappingType.Granted, ClaimMappingType.Denied] },
                new long [] { 1, 2, 3, 4 }
            ),
            (
                "Types Invalid",
            ...
            (
                "RoleIds Valid(1)",
                new ClaimMappingSearchCriteria() { RoleIds = [1] },
                new long [] { 1 }
            ),
            (
                "RoleIds Valid(2)",
                new ClaimMappingSearchCriteria() { RoleIds = [2] },
                new long [] { 2 }
            ),
            (
                "RoleIds Vaiid(multiple)",
                new ClaimMappingSearchCriteria() { RoleIds = [1, 2] },
                new long [] { 1, 2 }
            ),
            (
                "RoleIds Invalid",
            ...
            (
                ...
                new ClaimMappingSearchCriteria() { RoleIds = [1, 2], UserId = 1 },
                new long [] { 1, 2, 3 }
            ),
            (
                "Claims Valid(1)",
                new ClaimMappingSearchCriteria() { Claims = [AuthorizationClaim.AuthorizationConfigure] },
                new long [] { 1, 4 }
            ),
            (
                "Claims Valid(2)",
                new ClaimMappingSearchCriteria() { Claims = [AuthorizationClaim.DesignatedChannelMappingCreate] },
                new long [] { 2 }
            ),
            (
                "Claims Valid(multiple)",
                new ClaimMappingSearchCriteria() { Claims = [AuthorizationClaim.AuthorizationConfigure, AuthorizationClaim.DesignatedChannelMappingCreate] },
                new long [] { 1, 2, 4 }
            ),
            (
                "Claims Invalid",
